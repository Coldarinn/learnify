...
import { createStaticHandler, createStaticRouter, type RouteObject, StaticRouterProvider } from "react-router"

import { routes } from "./router"

export async function render(request: express.Request, response: express.Response) {
  const { query, dataRoutes } = createStaticHandler(routes as RouteObject[])
